...
void MaxScoreAI::initialize (Dictionary* dict){
	d = dict;
...
void MaxScoreAI::getMove (Board* board, Player* player,	char& direction, std::string& word, std::string& wordToUse, 
							int& row, int& col){
...
bool MaxScoreAI::getMoveHelper(Board* board, Player* player, char& direction, string& word, std::string& wordToUse,
...
void MaxScoreAI::permutations(std::vector<std::string>& perms, int pos, string str){
	string permutation;
	int size = str.size();
...
bool MaxScoreAI::findPrefix(std::string word){
